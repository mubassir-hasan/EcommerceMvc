...
namespace Ecommerce_MVC_Core.Migrations
{
    ...
    [Migration("20210325182739_Mig_OrderDetailsChangedOneToOneToOneTOMany")]
    partial class Mig_OrderDetailsChangedOneToOneToOneTOMany
    {
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.OrderStatus", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2021, 3, 26, 0, 27, 39, 99, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.ProductLikes", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2021, 3, 26, 0, 27, 39, 84, DateTimeKind.Local));
