...
namespace Ecommerce_MVC_Core.Migrations
{
    ...
    [Migration("20210327060417_Mig_OrderStatusModifed")]
    partial class Mig_OrderStatusModifed
    {
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.OrderStatus", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2021, 3, 27, 12, 4, 17, 710, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.ProductLikes", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2021, 3, 27, 12, 4, 17, 693, DateTimeKind.Local));
