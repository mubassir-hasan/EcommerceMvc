...
namespace Ecommerce_MVC_Core.Migrations
{
    ...
    [Migration("20180118205134_mig_orderStatus")]
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.ProductLikes", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 1, 19, 2, 51, 34, 517, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.OrderDetails", b =>
                {
                    ...
                    b.HasOne("Ecommerce_MVC_Core.Models.Admin.Product", "Product")
                        .WithOne("OrderDetails")
                        .HasForeignKey("Ecommerce_MVC_Core.Models.Admin.OrderDetails", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.Orders", b =>
                {
                    ...
                    b.HasOne("Ecommerce_MVC_Core.Models.Admin.OrderStatus", "OrderStatus")
                        .WithOne("Orders")
                        .HasForeignKey("Ecommerce_MVC_Core.Models.Admin.Orders", "OrderStatusId");
